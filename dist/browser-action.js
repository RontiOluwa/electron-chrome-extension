        ...
        this.update = state => {
          ...
          for (const action of state.actions) {
            ...
            if (!browserActionNode) {
              ...
              (_this$shadowRoot2 = this.shadowRoot) === null || _this$shadowRoot2 === void 0 || _this$shadowRoot2.appendChild(browserActionNode);
            }
...
.badge {
  ...
  try {
    electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld('browserAction', browserAction);
